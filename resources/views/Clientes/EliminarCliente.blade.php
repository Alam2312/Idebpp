    ...
    <form class="row g-3 needs-validation" method="POST" action="/Clientes/{{$Cliente->id}}">
      ...
      @method("DELETE") 
        <div class="col-md-4">
          ...
          <input type="text" class="form-control" id="validationCustom01" value="{{$Cliente->Nombre}}" name="Nombre" readonly>
        ...
        <div class="col-md-4">
          ...
          <div class="input-group has-validation">
            <input type="text" class="form-control"value="{{$Cliente->Telefono}}" id="validationCustomUsername" aria-describedby="inputGroupPrepend" method="POST" name="Telefono" readonly>
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="validationCustom02" value="{{$Cliente->Correo}}" method="POST" name="Correo" readonly>
            <div class="valid-feedback">
              Looks good!
            </div>
          </div>      
            ...
            <tbody>
              <tr>
                <th scope="row">@if($Info->Confirmacion1 != 0)
                  ...
                  @else
                  <a href="/VotarC/{{$Cliente->id}}">Confirmar</a>
                 @endif 
                </th>
